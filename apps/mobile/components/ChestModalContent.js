...
export default function ChestModalContent({ onClose }) {
  return (
    <View style={{ width: '86%', borderRadius: 16, backgroundColor: 'white', padding: 16 }}>
      <Text style={{ fontSize: 18, fontWeight: '700', marginBottom: 8 }}>보물상자</Text>
      <Text style={{ color: '#475569', marginBottom: 16 }}>보물상자 컨텐츠</Text>
      <Pressable
        onPress={onClose}
